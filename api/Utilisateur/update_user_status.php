...
// ------------------------------------------------------------
// Vérification : seul un super_admin peut modifier le statut d'un utilisateur
// ------------------------------------------------------------
...
try {
    ...
    // ------------------------------------------------------------
    // Mise à jour du statut via la méthode orientée objet
    // ------------------------------------------------------------
    $result = $controleur->mettreAJourStatut($id, $statut);
